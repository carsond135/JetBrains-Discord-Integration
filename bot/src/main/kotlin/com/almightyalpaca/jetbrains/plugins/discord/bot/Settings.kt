        ...
        data class Group(val name: String? = null, val roles: Set<Role>) {
            ...
            data class Role(val name: String? = null, val id: Long, val triggers: Trigger?) {
                data class Trigger(
                    ...
                    val states: Set<Long> = setOf(),
                    val details: Set<Long> = setOf(),
                    val partyIds: Set<Long> = setOf(),
                    val largeImageKeys: Set<Long> = setOf(),
                    val largeImageTexts: Set<Long> = setOf(),
                    val smallImageKeys: Set<Long> = setOf(),
                    val smallImageTexts: Set<Long> = setOf(),
                ) {
