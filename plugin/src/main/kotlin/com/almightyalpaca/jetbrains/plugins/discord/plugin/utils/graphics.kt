...
object Roboto {
    var regular: Font = Font.createFont(Font.TRUETYPE_FONT, Roboto::class.java.getResourceAsStream("/discord/fonts/roboto/Roboto-Regular.ttf"))
    var medium: Font = Font.createFont(Font.TRUETYPE_FONT, Roboto::class.java.getResourceAsStream("/discord/fonts/roboto/Roboto-Medium.ttf"))
    var bold: Font = Font.createFont(Font.TRUETYPE_FONT, Roboto::class.java.getResourceAsStream("/discord/fonts/roboto/Roboto-Bold.ttf"))
    var black: Font = Font.createFont(Font.TRUETYPE_FONT, Roboto::class.java.getResourceAsStream("/discord/fonts/roboto/Roboto-Black.ttf"))
}
